...
const ChatWithAi = () => {
  ...
  const videoAnalysisYesNoMaybeHandler = async (ans : number) => {
    ...
    if(ans == 1){
      ...
      await axios
      .post(baseUrl + `/chat-with-ai/get-response`, {prompt: yseText}, {
      ...
      await axios
      .post(baseUrl + `/chat-with-ai/get-response`, {prompt: noText}, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
        setMessages([
      ...
      await axios
      .post(baseUrl + `/chat-with-ai/get-response`, {prompt: maybeText}, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
        setMessages([
